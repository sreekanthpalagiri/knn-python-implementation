...
print('Select Scaler from below:')
print(selscaler)
selscaler=input()
if selscaler=='':
    print('Treating scaler as Min-Max')
    selscaler=2
selscaler=int(selscaler)
...
scaled_x_test = transformer.transform(x_test)
...
"""
for index, testrow in enumerate(scaled_x_test):
    eucdist, srtorder = calculatedistances(scaled_x_train,testrow)
